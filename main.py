...
# Dados iniciais do roadmap
roadmap = [
    {"Tarefa": "Estudar Python", "Status": "Pendente", "Descrição": "Aprender os fundamentos de Python."},
    {"Tarefa": "Ler sobre Tkinter", "Status": "Em Progresso", "Descrição": "Entender como criar interfaces gráficas."},
    {"Tarefa": "Praticar projetos", "Status": "Concluído", "Descrição": "Desenvolver mini-projetos para prática."},
]
...
tk.Button(root, text="Salvar em PDF", command=salvar_pdf).pack(pady=10)
